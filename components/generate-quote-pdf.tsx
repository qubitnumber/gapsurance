...
export default function GenerateQuotePDF({ quoteId }: { quoteId: string}) {
        ...
        <div className="bg-teal-500 hover:bg-teal-600 text-white">
            <Dialog>
                <DialogTrigger asChild>
                    <Button variant="default" disabled={downloading}>Get My Quote</Button>
                </DialogTrigger>
                {downloading && (
                    <div style={{
                        position: "fixed",
                ...
                <DialogContent>
                    ...
                    <DialogClose asChild>
                        <Button variant="default" onClick={() => handleDownload()}>Yes, Download</Button>
                    </DialogClose>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
